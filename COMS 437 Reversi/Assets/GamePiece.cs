...
//				direction.Normalize ();
//				transform.Translate (direction.x * 2 * Time.deltaTime, direction.y * 2 * Time.deltaTime, direction.z * 2 * Time.deltaTime);
//			} else {
//				if (!endTranslate)
//					destination.y -= 1;
//				else {
...
//			}
//
//			if (Quaternion.Angle (transform.rotation, target) < 0.5 && Vector3.Distance (transform.position, destination) < 0.05f) {
//				flip = false;
//			}
